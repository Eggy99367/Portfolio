  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-start gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="flex flex-col gap-1 pt-2 sm:pt-4">
              <span className="text-xs font-light uppercase tracking-widest text-[#0C0C0C]/60 sm:text-sm">
                {project.category}
              </span>
              <h3 className="text-2xl font-medium uppercase text-[#0C0C0C] sm:text-3xl md:text-4xl">
                {project.name}
              </h3>
            </div>
          </div>
        ...
        <p className="max-w-3xl text-sm font-light leading-relaxed text-[#0C0C0C]/70 sm:text-base">
          {project.description}
        </p>
